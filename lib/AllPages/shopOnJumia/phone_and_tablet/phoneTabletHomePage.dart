...
class PhoneTabletHomePage extends StatefulWidget {

  @override
  _PhoneTabletHomePageState createState() => _PhoneTabletHomePageState();
}

class _PhoneTabletHomePageState extends State<PhoneTabletHomePage> {
  @override
            ...
            child: Card(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('Wehre to Buy pone and tablest online',style: TextStyle(fontSize:20),),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('shopping online for mobile phone has nerver been and easy ltaks . our llove for phone and tablet'),
                  )
                ],
              ),
