...
class GotvHomePage extends StatefulWidget {
  const GotvHomePage({Key key}) : super(key: key);

  @override
  _GotvHomePageState createState() => _GotvHomePageState();
}
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: editTextfield('WHAT IS YOUR UIC NUMBERS?'),
            ),
            Container(
                height: 70,
                ...
                child: Padding(
                  ...
                  child: TextField(
                    decoration:
                    InputDecoration(labelText: 'UIC number'),
                  ),
                )),
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 15,right: 15,top: 15),
              child: editTextfield('CHOOSE A PACKAGE VARIANT'),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Container(
                      ...
                      child: Expanded(
                        child: Padding(
                          ...
                          child: Container(
                              child: TextField(
                                decoration:
                                InputDecoration(labelText: 'Packagevariant',
                                  suffixIcon: Icon(
                                    Icons.arrow_drop_down,
                                    color: Colors.black,
                                  ),
...
class _GotvHomePageState extends State<GotvHomePage> {
