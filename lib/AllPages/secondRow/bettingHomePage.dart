...
class BettingHomePage extends StatefulWidget {
  const BettingHomePage({Key key}) : super(key: key);

  @override
  _BettingHomePageState createState() => _BettingHomePageState();
}
...
class _BettingHomePageState extends State<BettingHomePage> {
