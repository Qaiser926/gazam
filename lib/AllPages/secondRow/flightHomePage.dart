      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            //   child: editTextfield('WHAT IS YOUR ACCOUNT ID?'),
            // ),
            // Padding(
            //   padding: const EdgeInsets.all(8.0),
            //   child: Container(
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: editTextfield('WHAT IS YOUR PAYMENT REF NUMBER (I.E.504*******)'),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Expanded(
                          child: Container(
                              child: TextField(
                                decoration:
                                InputDecoration(hintText: 'Reference Number'),
                              )),
                        ),
                      ),
                    ),
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text("Air Peace",style: TextStyle(fontSize: 12),),
                  ],
                ),
                Column(
                  children: [
                    ...
                    Text("Ibom Air",style: TextStyle(fontSize: 12),),
                  ],
                ),
                // Column(
                //   children: [
                ...
                Column(
                  children: [
                    ...
                    Text("Travelbeta",style: TextStyle(fontSize: 12),),
                  ],
                ),
              ],
            ),
