...
class PlayStationHomePage extends StatefulWidget {
  @override
  _PlayStationHomePageState createState() => _PlayStationHomePageState();
}
...
class _PlayStationHomePageState extends State<PlayStationHomePage> {
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text("Playstation",style: TextStyle(fontSize: 12),)
                  ],
                ),
                Column(
                  children: [
                    ...
                    Text("Free fire max",style: TextStyle(fontSize: 12),)
                  ],
                ),
                Column(
                  children: [
                    ...
                    Text("Free Fire",style: TextStyle(fontSize: 12),)
                  ],
                ),
              ],
            ),
