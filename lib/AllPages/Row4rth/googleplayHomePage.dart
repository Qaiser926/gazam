...
class GooglePlayHomePage extends StatefulWidget {
  const GooglePlayHomePage({Key key}) : super(key: key);

  @override
  _GooglePlayHomePageState createState() => _GooglePlayHomePageState();
}
...
class _GooglePlayHomePageState extends State<GooglePlayHomePage> {
